...
class TestRegistration():
    ...
    def test_registration(self):
        ...
        self.driver.find_element(By.ID, "input-firstname").send_keys("ankur")
        self.driver.find_element(By.ID, "input-lastname").click()
        self.driver.find_element(By.ID, "input-lastname").send_keys("waghamode")
        self.driver.find_element(By.ID, "input-email").click()
        self.driver.find_element(By.ID, "input-email").send_keys("waghmodeankur@gmail.com")
        self.driver.find_element(By.ID, "input-telephone").click()
        self.driver.find_element(By.ID, "input-telephone").send_keys("7416996876")
